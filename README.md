...
[Part 4: Features: When Game is over, there is a button to press to restart. Added a bomb to the game which affects the score and makes it harder. Added additional sound effects for when the bomb hits and when the game is over. ] 
